...
const data = read('src/demoData.ts')
...
assert.match(compose, /<ScheduleSendControl/)
assert.match(compose, /scheduledFor \? \{ scheduledFor \} : \{\}/)
...
assert.match(compose, /\.rich-compose-link, \.compose-schedule-menu/)
